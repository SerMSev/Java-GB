...
public class task2 {
    ...
    private static String[] create_strings(String[][] arraystr) {
        String[] new_str = new String[arraystr.length];
    ...
    public static void main(String[] args) {
        String strjsn_offile = getLineOffile("task2.txt");
        System.out.println(strjsn_offile);
        String[] array = create_strings(jsnparsetoarray(strjsn_offile));
